...
environments {
    development {
		...
		grails.file.upload = "/opt/myimage/"
...
grails.plugin.springsecurity.successHandler.defaultTargetUrl = '/request'
...
//grails.plugin.springsecurity.switchUser.exitUserUrl = '/user'
